...
Focused on a clean, recruiter-friendly overview of my projects and skills.
...
- Highlights:
  ...
  - Resilient timer logic using wall-clock elapsed time (handles browser throttling)
...
- Highlights:
  ...
  - Deployed as a fast static web app
...
- If you fork this repo, remember to update the project links above.
- For questions or contact: **(add email / LinkedIn here)**.
